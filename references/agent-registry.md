...
| # | Agent Name | 文件路径 | 职责 | 工具 |
|---|-----------|---------|------|------|
| 35 | `paper-submission-format-check-consultant` | `agents/format-check-consultant.md` | Word 导出、版式规范、模板适配、标题层级和投稿格式风险 | Read, Grep |
| 36 | `paper-submission-citation-integrity-consultant` | `agents/citation-integrity-consultant.md` | 正文引用、文后参考文献、题录缺口和引用体例一致性 | Read, Grep |
| 37 | `paper-submission-journal-package-consultant` | `agents/journal-package-consultant.md` | 投稿包完整性、声明材料、cover/response letter 和回流项 | Read, Grep |
